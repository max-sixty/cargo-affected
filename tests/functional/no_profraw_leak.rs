...
//! `LLVM_PROFILE_FILE`. This scenario fails loudly if any leak escapes into
//! the workspace — it's the success criterion for the fix described in
//! the issue: no profraws anywhere outside `target/` after a clean collect.
